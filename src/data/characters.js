...
export const characters = {
  ...
  ricardo:  { characterName: 'Jamie Journalist',      role: 'Reporter',                pdfFile: 'Jamie.pdf' },
  ...
  joo:      { characterName: 'Vivienne Royale',       role: 'Gambler',                 pdfFile: 'GamblerA.pdf' },
  bryan:    { characterName: 'Full House Frank',      role: 'Gambler',                 pdfFile: 'Frank.pdf' },
  rhea:     { characterName: 'Diamond',               role: 'Entertainer',             pdfFile: 'EntertainerA.pdf' },
  ...
  mia:      { characterName: 'Mo',                    role: 'Security Staff',          pdfFile: 'SecurityA.pdf' },
